    ...
    <div class="container">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Sous Total:
                                {{ $order->items->sum(function ($item) {return $item->quantity * $item->price;}) }} XOF</p>
                            ...
                            <p>Avance : {{ $order->advance ?? '' }} XOF</p>
                            <p>Reste : {{ $order->reste ?? '' }} XOF</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="p-4 mt-4 bg-white">
            ...
            <div class=" row">
                ...
                <div class="col-md-3">
                    <button type="button" class="btn btn-primary active" data-toggle="modal"
                        data-target="#verticalCenteredModal">
                        Annuler la commande
                    </button>
                </div>
                <div class="col-md-3">
        ...
        <div class="modal fade" id="verticalCenteredModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
            aria-labelledby="verticalCenteredModalDemoLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
